...
{
    /// <summary>
    ///     Creates a basic MAME layout for displaying game information in-game.
    /// </summary>
    public class LayoutFactory
    {
        ...
        /// </summary>
        public void Serialize(MameLayout layout, Stream output)
        {
        ...
        /// <param name="bezelHeight">
        ///     height of bezel image. It is assumed that the bezel's width is the horizontal resolution of
        ///     the monitor
        /// </param>
        /// <param name="horizontal">if the game is in the horizontal rotation</param>
        public MameLayout Build(int monitorWidth, int monitorHeight, int bezelHeight, bool horizontal = true)
        {
