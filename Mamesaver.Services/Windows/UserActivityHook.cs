...
namespace Mamesaver.Services.Windows
{
    ...
    public class UserActivityHook : IActivityHook, IDisposable
    {
        ...
        public UserActivityHook() : this(typeof(UserActivityHook).Assembly)
        {
        }

        public UserActivityHook(Assembly callingAssembly) => _callingAssembly = callingAssembly;
        ...
        public void Start(bool installMouseHook, bool installKeyboardHook)
        {
            ...
            if (_hMouseHook == 0 && installMouseHook)
            {
                ...
                _hMouseHook = SetWindowsHookEx(
                    WH_MOUSE_LL,
                    _mouseHookProcedure,
                    Marshal.GetHINSTANCE(_callingAssembly.GetModules()[0]),
                    0);
